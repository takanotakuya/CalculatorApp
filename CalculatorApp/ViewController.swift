...
class ViewController: UIViewController {
    ...
    enum CalculateStatus {
        case none, plus, minus, multiplication, dezision
    }
...
extension ViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case .plus, .minus, .multiplication, .dezision:
    ...
    private func handleFirstNumberSelected(number: String) {
        ...
        case ".":
            if !confirmIncludeDecimalPoint(numcerString: firstNumber) {
                firstNumber += number
                numberLabel.text = firstNumber
            }
        case "+":
    ...
    private func handleSecondNumberSelected(number: String) {
        ...
        case ".":
            if !confirmIncludeDecimalPoint(numcerString: secondNumber) {
                secondNumber += number
                numberLabel.text = secondNumber
            }
        case "=":
    ...
    private func confirmIncludeDecimalPoint(numcerString: String) -> Bool {
        if numcerString.range(of: ".") != nil || numcerString.count == 0 {
            return true
        } else {
            return false
        }
